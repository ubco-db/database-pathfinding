...
{	
	...
	public boolean isFound(int k)
	{	// Returns true if given key is in closed list		
		int i = hashClosed(k);
	...
	public int getFoundVal(int k)
	{	// Returns the value associated with the previously visited id
	...
	public void setFound(int k, int val)
	{	// Sets the key in the closed list
		if (numClosed > closedList.length*.50)
		{	// Resize hash table
