...
public class StatsRecord {
    ...
    public void outputCSV(StatsRecord rec1, PrintWriter out) {
		...
		*/
        ...
        // Print the median
        if (rec2.arrayCount > 0)
            out.print(rec2.moveTimes[rec2.arrayCount / 2] + "\t");
		/*
		...
		*/
        ...
        // Worst 5
        if (rec2.arrayCount >= 4)
            out.print(rec2.moveTimes[4] + "\t");
        else
            out.print("\t");

        // Worst 10
        if (rec2.arrayCount >= 10)
            out.print(rec2.moveTimes[9] + "\t");
        else
            out.print("\t");
