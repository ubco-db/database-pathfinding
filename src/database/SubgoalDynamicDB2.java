...
{			
	...
	{			
		...
		if (pathSize == 0)
			return null;			// No path between two states				
		int startId = path[0];
	...
	{	// Load dynamic programming table and records
		Scanner sc = null;
		...
		{	sc = new Scanner(new File(fileName));
			...
			{	// Read each group which has # neighbors as N, neighborId[N], lowest cost[N], neighbor[] and paths on each line
	...
	{	// Save dynamic programming table and records
		// Format: numGroups
