...
public class Entry implements Comparable<Entry> {
    ...
    public Entry(double percentageChanged, int wallId, ArrayList<ChangedPath> changedPaths) {
        ...
        this.output = String.format("Wall at: %d. Percentage of goals changed: %.2f.\t%.2f percent of goals had a 0-25%% change in their paths, %.2f percent had a 25-50%% change, %.2f percent had a 50-75%% change, and %.2f percent had a 75-100%% change", wallId, percentageChanged, amountChanged[0], amountChanged[1], amountChanged[2], amountChanged[3]);
    }
    ...
    private double[] getAmountChanged(ArrayList<ChangedPath> changedPaths) {
        ...
        // TODO: fix NaN values being returned
