...
public class StringFunc {
    ...
    public static void printResultSet(ResultSet rst) throws SQLException {
        ...
        while (rst.next()) {
            if (meta.getColumnType(1) == java.sql.Types.INTEGER) System.out.print(rst.getInt(meta.getColumnName(1)));
            else System.out.print(rst.getString(meta.getColumnName(1)));
            for (int j = 2; j <= meta.getColumnCount(); j++)
                ...
                else System.out.print(", " + rst.getString(meta.getColumnName(j)));
            System.out.println();
            i++;
        }
    }
